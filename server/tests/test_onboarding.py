...
from app.ai.mission import get_mission_slots, generate_round, load_prop_dict
...
def test_mission_slots_cover_all_floors() -> None:
    all_slots = get_mission_slots()
    assert len(all_slots) >= 9
